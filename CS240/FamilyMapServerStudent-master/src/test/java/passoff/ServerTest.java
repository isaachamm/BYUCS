...
public class ServerTest {
    ...
    public void testValidEvent(TestInfo testInfo) {
        ...
        try {
            ...
            //We are creating a Service.Request.LoadRequest from the JsonReader we made
            ...
            assertEquals(loadRequest.getEvent(ASTEROIDS1_EVENT_ID), eventResult.toEvent(), "Event returned does not match event from Service.Request.LoadRequest");
            ...
            assertEquals(loadRequest.getEvent(ASTEROIDS2_EVENT_ID), eventResult.toEvent(), "Event returned does not match event from Service.Request.LoadRequest");
        } catch (ServerConnectionException e) {
            fail(e.getMessage());
