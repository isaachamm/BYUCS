...
//            unsigned int specialCurrLine = 0;
//
//            if(maxAutomaton->getType() == COMMENT || maxAutomaton->getType() == STRING
//                || maxAutomaton->getType() == UNDEFINED) {
//                specialCurrLine = (currLine - maxAutomaton->getNewLines());
//                Token currToken = Token(maxAutomaton->getType(), input.substr(0, maxRead),
//                                        specialCurrLine/*defaults to 0, you will need to fix for the project*/);
